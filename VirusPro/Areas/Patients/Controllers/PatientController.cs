...
namespace VirusPro.Controllers
{
    [Area("Patients")]
	...
	public partial class PatientController : BaseApiController
    {
        ...
        {
            return Ok(DC.Set<City>().GetSelectListItems(Wtm, x => x.CityName));
        }

        [HttpGet("GetHospitals")]
        public ActionResult GetHospitals()
        {
            return Ok(DC.Set<Hospital>().GetSelectListItems(Wtm, x => x.HostpitalName));
        }

        [HttpGet("GetViruss")]
        public ActionResult GetViruss()
        {
            return Ok(DC.Set<Virus>().GetSelectListItems(Wtm, x => x.VirusName));
        }
